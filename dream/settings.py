...
SECRET_KEY = 'django-insecure-1h^v#0dkhgzno2h_oveb70uu*_-14=6nt@!wo0qbr+49zc)y8o'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'note_mydairy',         # Replace with your database name
        'USER': 'root',         # Replace with your MySQL username
        'PASSWORD': 'root',          # Replace with your MySQL password
        'HOST': '127.0.0.1',                  # Database host (use '127.0.0.1' or IP address)
